...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    externalTokens: {
      ...
      'SUVC_USDT(HECO)-LP': ['0x1a5c56CeEf83AaC7E303C1BfD151B4328af6fb13', 18],
      'SUVS_USDT(HECO)-LP': ['0xFA02243ee9b7557d308A84060b6195E26A691033', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  SUVCLPTokenSharePool: {
    name: 'Earn SUVS by SUVC-USDT(HECO)-LP',
    contract: 'SUVCLPTokenSharePool',
    depositTokenName: 'SUVC_USDT(HECO)-LP',
    earnTokenName: 'SUVS',
    finished: false,
    sort: 1,
  },
  SUVSLPTokenSharePool: {
    name: 'Earn SUVS by SUVS-USDT(HECO)-LP',
    contract: 'SUVSLPTokenSharePool',
    depositTokenName: 'SUVS_USDT(HECO)-LP',
    earnTokenName: 'SUVS',
    finished: false,
    sort: 2,
  },
  ...
  SUVCLPLockTokenSharePool: {
    name: 'Earn SUVS by SUVC-USDT(HECO)-LP(LOCK)',
  ...
  SUVSLPLockTokenSharePool: {
    name: 'Earn SUVS by SUVS-USDT(HECO)-LP(LOCK)',
